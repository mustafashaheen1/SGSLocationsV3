...
-- Update all existing sub-categories to be visible by default
UPDATE categories
...
'Controls whether this sub-category appears as a tab in the location library page. Only applicable to sub-categories (parent_id IS NOT NULL). Defaults to true.';
