    ...
    <main className="min-h-screen bg-white pt-[110px]">
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-red-600 mb-4">List Your Property</h1>
        ...
        <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label htmlFor="internationalPhone" className="block font-medium text-gray-700 mb-1">
                    International Phone
                  </label>
                  <input
                    type="tel"
                    ...
                    onChange={handleInputChange}
                    className="w-full border border-gray-300 rounded p-2 focus:ring-2 focus:ring-red-500 focus:outline-none"
                  />
                </div>
              </div>
            </section>
            ...
            {/* Property Address */}
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Property Address</h2>
              <div className="space-y-4">
                <div>
                  <label htmlFor="streetAddress" className="block font-medium text-gray-700 mb-1">
                ...
                <div>
                  <label htmlFor="addressLine2" className="block font-medium text-gray-700 mb-1">
                    Address Line 2
                  </label>
                  <input
                    type="text"
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label htmlFor="zipCode" className="block font-medium text-gray-700 mb-1">
              ...
              <div>
                ...
                {formData.propertyRole === 'other' && (
                  <input
                    ...
                    className="w-full border border-gray-300 rounded p-2 mt-2 focus:ring-2 focus:ring-red-500 focus:outline-none"
                  />
                )}
          ...
          <div className="space-y-8">
            ...
            <section>
              <div className="mb-2">
                ...
                <p className="text-sm text-gray-600">(Only JPGs and PNGs accepted.)</p>
              </div>
              <div
                onDragOver={handleDragOver}
                onDragLeave={handleDragLeave}
                onDrop={handleDrop}
                className={`border-2 border-dashed rounded bg-gray-50 min-h-[300px] flex flex-col items-center justify-center p-8 transition-colors ${
              ...
              >
                ...
                <label className="cursor-pointer bg-red-600 text-white px-6 py-2 rounded hover:bg-red-700 transition-colors">
                  Browse Files
                  <input
                    type="file"
                    multiple
                ...
                {uploadedFiles.length > 0 && (
                  <div className="mt-4 w-full">
                    <p className="font-medium text-gray-700 mb-2">{uploadedFiles.length} file(s) selected:</p>
            ...
            <section>
              <label className="block font-medium text-gray-700 mb-2">Terms and Conditions</label>
              <div className="max-h-[300px] overflow-y-scroll border border-gray-300 rounded p-4 bg-gray-50 text-sm leading-relaxed">
                <p className="mb-4">
            ...
            <section>
              <label className="flex items-start">
                <input
                  ...
                  className={`w-4 h-4 text-red-600 focus:ring-red-500 rounded mt-1 ${
            ...
            <section className="bg-gray-100 p-4 rounded">
              <p className="font-bold text-gray-900 mb-2">PLEASE NOTE</p>
              <p className="text-sm text-gray-700 mb-1"><span className="text-red-600">*</span> Indicates required fields</p>
              <p className="text-sm text-gray-700">All submissions are subject to review & approval by SGS Locations</p>
            </section>

            {/* reCAPTCHA Placeholder */}
            <div className="text-center my-4 p-4 bg-gray-100 rounded border border-gray-300">
              <p className="text-sm text-gray-600">reCAPTCHA verification will appear here</p>
            </div>
          </div>
          ...
          <div className="md:col-span-2">
            <button
              type="submit"
              className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-8 text-lg rounded transition-colors"
            >
              Submit
            </button>
          </div>
        ...
        <footer className="bg-white py-8 mt-12 border-t border-gray-200">
          <div className="text-center space-y-4">
            ...
            <div className="flex items-center justify-center gap-3 text-2xl text-gray-900">
              ...
              <a href="tel:2145550123" className="hover:text-red-600 transition-colors font-semibold">
                (214) 555-0123
              </a>
            </div>
            <p className="text-gray-600">We're committed to serving the Dallas-Fort Worth film industry</p>
          </div>
        </footer>
      </div>
    </main>
