  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white">
          ...
          <div className="col-md-6 py-5 px-md-5 d-flex justify-content-center align-items-center flex-column m-order-1">
            <div className="w-100">
              ...
              {sections[1]?.linkText && sections[1]?.linkUrl && (
                <Link href={sections[1].linkUrl} className="text-[#cc5500] hover:underline font-medium">
                  {sections[1].linkText}
                </Link>
              )}
            </div>
        ...
        {/* SECTION 5: Media Left, Content Right OR Text Only Centered */}
        ...
        {/* SECTION 7: Media Left, Content Right OR Text Only Centered */}
            ...
            <div className={`${!sections[7]?.image && !sections[7]?.videoUrl ? 'col-12' : 'col-md-6'} py-5 px-md-5 d-flex justify-content-center align-items-center flex-column ${sections[7]?.image || sections[7]?.videoUrl ? 'm-order-1' : ''}`}>
              <div className={`${!sections[7]?.image && !sections[7]?.videoUrl ? 'text-center' : ''} w-100`}>
                ...
                {sections[7]?.linkText && sections[7]?.linkUrl && (
                  <Link href={sections[7].linkUrl} className="text-[#cc5500] hover:underline font-medium">
                    {sections[7].linkText}
                  </Link>
                )}
              </div>
        ...
        {/* SECTION 9: Media Left, Content Right OR Text Only Centered */}
            ...
            <div className={`${!sections[8]?.image && !sections[8]?.videoUrl ? 'col-12' : 'col-md-6'} py-5 px-md-5 d-flex justify-content-center align-items-center flex-column`}>
              <div className={`${!sections[8]?.image && !sections[8]?.videoUrl ? 'text-center' : ''} w-100`}>
                ...
                {sections[8]?.linkText && sections[8]?.linkUrl && (
                  <Link href={sections[8].linkUrl} className="text-[#cc5500] hover:underline font-medium">
                    {sections[8].linkText}
                  </Link>
                )}
              </div>
          ...
          <section className="row py-5">
            <div className="offset-md-3 col-md-6 d-flex justify-content-center flex-column px-md-5 py-5 text-center">
              ...
              {sections[10]?.linkText && sections[10]?.linkUrl && (
                <a href={sections[10].linkUrl} target="_blank" className="text-[#cc5500] hover:underline font-medium text-lg">
