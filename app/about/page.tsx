      ...
      <div className="container pt-4">
          ...
          <div className="col-md-6 py-5 px-md-5 d-flex justify-content-center align-items-center flex-column m-order-1">
            <div className="w-100">
              ...
              <p className="text-gray-700 mb-4">
                Whether you're looking for a sprawling ranch, modern architecture, historic properties, or urban settings, SGS Locations has the perfect backdrop for your production needs. Watch our overview video to see what we offer.
              </p>
            </div>
          </div>
        ...
        <section className="row py-5">
          <div className="offset-md-3 col-md-6 d-flex justify-content-center flex-column px-md-5 py-5 text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Trusted by Major Productions</h2>
        ...
        <section className="row">
          <div className="d-flex col-md-6 justify-content-center align-items-center border">
            <Image
              src="https://images.unsplash.com/photo-1495020689067-958852a7765e?w=800"
        ...
        <section className="row">
          <div className="d-flex col-md-6 justify-content-center align-items-center border">
            <Image
              src="https://images.unsplash.com/photo-1554224311-beee460c201f?w=800"
        ...
        <section className="row py-5">
          <div className="offset-md-3 col-md-6 d-flex justify-content-center flex-column px-md-5 py-5 text-center">
            ...
            <a href="/pdfs/code-of-conduct.pdf" target="_blank" className="text-[#dc2626] hover:underline font-medium text-lg">
