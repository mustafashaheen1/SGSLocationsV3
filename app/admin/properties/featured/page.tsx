...
export default function FeaturedPropertiesPage() {
  ...
  async function removeFeatured(id: string) {
    try {
      ...
      showSuccess('Property removed from featured');
      fetchProperties();
    } catch (error: any) {
  ...
  const filteredProperties = properties.filter(property => {
    ...
    // Check owner information (featured properties can be admin or user-created)
    if (
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="text-sm text-gray-600">
          {filteredProperties.length} featured {filteredProperties.length === 1 ? 'property' : 'properties'}
        </div>
      </div>
          ...
          <>
            ...
            {filteredProperties.length === 0 && (
              <div className="text-center py-12 text-gray-500">
                ...
                <p className="text-sm mt-2">Featured properties will appear here</p>
              </div>
            )}
          </>
        )}
