...
export default function PortfolioPage() {
  const portfolioItems = [
    ...
    { id: 3, image: 'https://images.unsplash.com/photo-1598899134739-24c46f58b8c0?w=1200&q=80', title: 'Harper Bazaar Magazine', aspectRatio: 1.6 },
    ...
    { id: 7, image: 'https://images.unsplash.com/photo-1560179707-f14e90ef3623?w=1200&q=80', title: 'McDonald Commercial', aspectRatio: 1.8 },
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white" style={{ paddingTop: '110px' }}>
        ...
        {/* Portfolio Grid - FULL WIDTH WITH FLEXBOX */}
        <div className="portfolio-grid">
          {portfolioItems.map((item) => (
            <div
              ...
              style={{
                flexBasis: `${item.aspectRatio * 400}px`
              }}
            >
              {/* Image */}
              <Image
