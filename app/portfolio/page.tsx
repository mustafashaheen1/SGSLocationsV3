...
export default function PortfolioPage() {
  const portfolioItems = [
    ...
    { id: 4, image: 'https://images.unsplash.com/photo-1598928506311-c55ded91a20c?w=1200&q=80', title: 'Vanity Fair - Selena Gomez', aspectRatio: 0.7 },
    ...
    { id: 6, image: 'https://images.unsplash.com/photo-1522093537031-3ee69e6b1746?w=1200&q=80', title: 'On Call - Prime Series', aspectRatio: 0.8 },
    { id: 7, image: 'https://images.unsplash.com/photo-1560179707-f14e90ef3623?w=1200&q=80', title: 'McDonald Commercial', aspectRatio: 1.3 },
    { id: 8, image: 'https://images.unsplash.com/photo-1551434678-e076c223a692?w=1200&q=80', title: 'Elle Magazine', aspectRatio: 0.9 },
    { id: 9, image: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=1200&q=80', title: 'W Magazine', aspectRatio: 1.4 },
    ...
    { id: 12, image: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=1200&q=80', title: 'People Magazine', aspectRatio: 0.6 },
    { id: 13, image: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=1200&q=80', title: 'Town & Country', aspectRatio: 1.3 },
    ...
    { id: 16, image: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=1200&q=80', title: 'The Golden Bachelor', aspectRatio: 1.0 },
    ...
    { id: 21, image: 'https://images.unsplash.com/photo-1511379938547-c1f69419868d?w=1200&q=80', title: 'Live Performance', aspectRatio: 1.1 },
    ...
    { id: 23, image: 'https://images.unsplash.com/photo-1478720568477-152d9b164e26?w=1200&q=80', title: 'Indie Film', aspectRatio: 0.9 },
    { id: 24, image: 'https://images.unsplash.com/photo-1518929458119-e5bf444c30f4?w=1200&q=80', title: 'TV Commercial', aspectRatio: 1.2 },
    { id: 25, image: 'https://images.unsplash.com/photo-1497366672149-e5e4b4d34eb3?w=1200&q=80', title: 'Brand Campaign', aspectRatio: 1.9 },
    { id: 26, image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=1200&q=80', title: 'Theater Production', aspectRatio: 0.7 },
    ...
    { id: 29, image: 'https://images.unsplash.com/photo-1564177416131-aa37b0be4804?w=1200&q=80', title: 'Production Stills', aspectRatio: 0.8 },
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white" style={{ paddingTop: '110px' }}>
        ...
        <div style={{ paddingLeft: '1rem', paddingTop: '0', paddingBottom: '2rem' }}>
          <h1 style={{ fontSize: '2.5rem', color: '#212529', marginBottom: '0.5rem' }}>
            Recent Projects
          </h1>
        </div>

        {/* Portfolio Grid - SMALLER HEIGHT FOR 3-6 ITEMS PER ROW */}
